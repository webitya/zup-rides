...
import LocalFloristIcon from "@mui/icons-material/LocalFlorist"; // FIXED ICON
...
export default function AboutValues() {
  ...
  const values = [
    ...
    { icon: LocalFloristIcon, name: "Eco-Friendly", desc: "Supporting sustainable and clean transportation." }, // UPDATED
  ];
