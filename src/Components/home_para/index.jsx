...
export default function DiscoverSection() {
  return (
    <section className="relative bg-gradient-to-b from-white via-slate-50 to-white dark:from-neutral-800 dark:via-neutral-900 dark:to-neutral-800 py-16 px-6 md:px-12">
      <div className="max-w-4xl mx-auto text-center">
        <Typography
          variant="h3"
          component="h2"
          className="font-bold text-neutral-800 dark:text-white mb-6 transition-transform duration-500 hover:scale-105 hover:text-indigo-600 dark:hover:text-indigo-400"
        >
